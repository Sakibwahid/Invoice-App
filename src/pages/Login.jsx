  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-blue-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob" />
          ...
          <div className="relative">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/50 backdrop-blur-sm border border-white/30 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-slate-400 text-slate-900 transition-all"
                    disabled={loading}
                  />
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-white/50 text-slate-500">Don't have an account?</span>
              </div>
            </div>
            ...
            <Link
              to="/signup"
              className="w-full py-3 px-4 bg-white/50 hover:bg-white border border-white/30 hover:border-blue-200 text-blue-600 font-semibold rounded-xl transition-all duration-200 text-center block"
            >
              Create Account
            </Link>
          </div>
